...
class ProductScrapeConfig
{
    ...
    const COLOR_BLOCK = 'span.border.border-black.rounded-full.block';
    ...
    const COLOR_BLOCK_ATTR = 'data-colour';
    const AVAILABILITY_BLOCK = 'div.text-sm.block.text-center';
    const SHIPPING_TEXT_BLOCK = 'div.text-sm.block.text-center';
}